...
// */
//public class MQConfigurationManager {
//
//    private static final Logger                  LOG            = LoggerFactory.getLogger(MQConfigurationManager.class);
//
//    private final LinkedList<MQConfigurationEntry> configurations = new LinkedList<>();
//    private MQConfigurationEntry snapshot       = new MQConfigurationEntry();
//
//    /**
//     * Adds a new conf entry.
//     */
//    public boolean add(final MQConfigurationEntry entry) {
...
//    }
//
//    public MQConfigurationEntry getSnapshot() {
//        return this.snapshot;
//    }
//
//    public void setSnapshot(final MQConfigurationEntry snapshot) {
//        this.snapshot = snapshot;
//    }
//
//    public MQConfigurationEntry getLastConfiguration() {
//        if (this.configurations.isEmpty()) {
//            return snapshot;
//        } else {
...
//    }
//
//    public MQConfigurationEntry get(final long lastIncludedIndex) {
//        if (this.configurations.isEmpty()) {
...
//            return this.snapshot;
//        }
//        ListIterator<MQConfigurationEntry> it = this.configurations.listIterator();
//        while (it.hasNext()) {
