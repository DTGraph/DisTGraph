...
// */
//
//public class MQRocksDBLogStorage111 implements MQLogStorage, Describer {
//
//    private static final Logger LOG = LoggerFactory.getLogger(MQRocksDBLogStorage111.class);
//
...
//
//    public MQRocksDBLogStorage111(final String path) {
//        super();
//        this.path = path;
...
//        return StorageOptionsFactory.getRocksDBOptions(MQRocksDBLogStorage111.class);
//    }
//
//    public static ColumnFamilyOptions createColumnFamilyOptions() {
//        final BlockBasedTableConfig tConfig = StorageOptionsFactory
//                .getRocksDBTableFormatConfig(MQRocksDBLogStorage111.class);
//        return StorageOptionsFactory.getRocksDBColumnFamilyOptions(MQRocksDBLogStorage111.class) //
