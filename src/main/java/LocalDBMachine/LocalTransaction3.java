...
public class LocalTransaction3 extends Thread {
    ...
    public LocalTransaction3(GraphDatabaseService db, DTGOperation op, Map<Integer, Object> res, TransactionThreadLock lock, DTGRegion region){
        this.db = db;
    ...
    public LocalTransaction3(GraphDatabaseService db, DTGOperation op, Map<Integer, Object> res, TransactionThreadLock lock,
