 ...
 */
public class TxMQException extends Throwable {
    ...
    public TxMQException(EnumOutter.ErrorType type) {
        super(type.name());
        this.type = type;
    }

    public TxMQException(EnumOutter.ErrorType type, Status status) {
        super(status != null ? status.getErrorMsg() : type.name());
        this.type = type;
        this.status = status;
    }

    public TxMQException(EnumOutter.ErrorType type, TxMQError err, String fmt, Object... args) {
        super(String.format(fmt, args));
        this.type = type;
        this.status = new Status(err.getNumber(), fmt, args);
    }

    public TxMQException() {
