...
public class StatsCollector {
    ...
    public StatsCollector(DTGStoreEngine storeEngine) {
...
//        stats.setKeysRead(getStoreKeysRead(true));
    ...
    public DTGRegionStats collectRegionStats(final DTGRegion region, final TimeInterval timeInterval) {
        final DTGRegionStats stats = new DTGRegionStats();
...
//        if(region.isNodeChange()){
//            stats.setNodeIdRangeList(region.getNodeIdRegionList());
//        }
//
//        if(region.isRelationChange()){
//            stats.setRelationIdRangeList(region.getRelationIdRegionList());
//        }
//
//        if(region.isTemporalPropertyChange()){
//            stats.setTemporalPropertyTimeRangeList(region.getTemporalPropertyTimeRegionList());
//        }
...
//    }
    ...
    public long getRegionBytesWritten(final DTGRegion region, final boolean reset) {
    ...
    public long getRegionBytesRead(final DTGRegion region, final boolean reset) {
    ...
    public long getRegionKeysWritten(final DTGRegion region, final boolean reset) {
    ...
    public long getRegionKeysRead(final DTGRegion region, final boolean reset) {
