 ...
 * @author jiachun.fjc
 */
public interface DTGOutboundHandler extends DTGHandler {
     ...
     */
    void handleOutbound(final DTGHandlerContext ctx, final DTGOutboundMessageEvent<?> event) throws Exception;
}
