 ...
 * @author jiachun.fjc
 */
public class DTGInstruction implements Serializable {
    ...
    private AddRegionInfo     addRegion;
    ...
    public void setRegion(DTGRegion region) {
        this.region = region;
    }
    ...
    public AddRegionInfo getAddRegion() {
        return addRegion;
    }

    public void setAddRegion(AddRegionInfo addRegion) {
